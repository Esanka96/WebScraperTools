...
def new_function(url):
    ...
    # Send GET request
    response = scraper.get(url, headers=headers1)
...
new_function("https://bpspubs.onlinelibrary.wiley.com/action/downloadSupplement?doi=10.1111%2Fbph.16309&file=bph16309-sup-0004-Figure+S2.jpg")
