...
def new_function(pdf_link):
    ...
    pdf_content = scraper.get(pdf_link,headers=headers1).content
    with open(out_folder, 'wb') as file:
        file.write(pdf_content)



new_function("https://pubs.acs.org/doi/suppl/10.1021/acsmedchemlett.5c00370/suppl_file/ml5c00370_si_001.pdf")
