...
def new_function(pdf_link):
    ...
    response = scraper.get(pdf_link, headers=headers1).content
...
new_function("https://ordspub.epa.gov/ords/guideme_ext/guideme_ext/guideme/file/tri guidance for lead and lead compounds - february 2020 .pdf")
